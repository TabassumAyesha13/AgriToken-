...
set_background(r"C:\Users\Tabassum Ayesha H.R\Downloads\Harvest_Pay-main (2) (1)\Harvest_Pay-main\background.avif", opacity=0.5) 

# ------------------------------
# SIDEBAR MENU
# ------------------------------
sidebar_img_path = r"C:\Users\Tabassum Ayesha H.R\Downloads\Harvest_Pay-main (2) (1)\Harvest_Pay-main\credit.jpg"  # Replace with your actual path
...
if menu == "🏠 Home":
    ...
    # HOME PAGE CONTENT
    # ------------------------------
    home_img_path = r"C:\Users\Tabassum Ayesha H.R\Downloads\Harvest_Pay-main (2) (1)\Harvest_Pay-main\crop_image.jpg"
